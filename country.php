...
$result = mysqli_query($db, "SELECT * FROM `ss_setup_country`");
?>
<!doctype html>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="hstack gap-2">
                                                ...
                                                <button type="button" class="btn btn-info" id="coontry" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-add-line align-bottom me-1"></i> Add Country</button>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="country"><?php echo $row["country_name"]; ?></td>
                                                                ...
                                                                <td class="text-center" id="iditi"> <?php if ($row["is_active"] == '0') { ?>
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input id="SwitchCheck4<?php echo $row["country_id"]; ?>" role="switch" class="form-check-input" type="checkbox" name=toggle value="<?php echo $row["country_id"]; ?>">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input class="form-check-input" role="switch" id="toggle_<?php echo $row["country_id"]; ?>" type="checkbox" checked="" name=toggle value="<?php echo $row["country_id"]; ?>" data-toggle="toggle" data-off="Closed" data-on="Open">
                                                                                <span class="slider round mixin"></span>
                                                                            </label>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                            <a name="edit" id="<?php echo $row["country_id"]; ?>" data-id="<?php echo $row["country_id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                                        </li>
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                                            <a class="delete_product" data-id='<?php echo $row['country_id']; ?>'>
            ...
            <div data-simplebar style="height: calc(100vh - 112px);">
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Country Name</label>
                            <input type="text" id="country" name="country" class="form-control" placeholder="Select Address" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Number Of Ports</label>
                            <input type="number" id="ports" name="ports" class="form-control" placeholder="Select Company Name" required="">
                        </div>
    ...
    <script>
        $('input[name=toggle]').change(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'country_status/active_inactiv.php',
                data: {
                    mode: mode,
                    id: id
                },
        ...
        $(document).ready(function() {
            ...
            $('#insert').on("click", function(event) {
                ...
                if ($('#fname').val() == "") {
                    ...
                    $.ajax({
                        url: "country_api/insert_update_country.php",
                        method: "POST",
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                // alert(employee_id)
                $.ajax({
                    url: "country_api/fetch_country.php",
                    method: "POST",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $('#employee_id').val(data.country_id);
                        $('#country').val(data.country_name);
                        $('#ports').val(data.no_of_ports);
            ...
            $(document).on('click', '.delete_product', function(e) {
                ...
                if (confirmalert == true) {
                    // AJAX Request
                    $.ajax({
                        url: 'country_api/delet_country.php',
                        type: 'POST',
                        data: {
                            id: deleteid
                        },
