...
$result = mysqli_query($db, "SELECT * FROM `ss_setup_port` as po INNER join ss_setup_country as co on po.country_id_fk = co.country_id;
");
?>
<!doctype html>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="country">Ports</th>
                                                                ...
                                                                <td class="text-center" id="iditi"> <?php if ($row["is_active"] == '0') { ?>
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input id="SwitchCheck4<?php echo $row["port_id"]; ?>" role="switch" class="form-check-input" type="checkbox" name=toggle value="<?php echo $row["port_id"]; ?>">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input class="form-check-input" role="switch" id="toggle_<?php echo $row["port_id"]; ?>" type="checkbox" checked="" name=toggle value="<?php echo $row["port_id"]; ?>" data-toggle="toggle" data-off="Closed" data-on="Open">
                                                                                <span class="slider round mixin"></span>
                                                                            </label>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                            <a name="edit" id="<?php echo $row["port_id"]; ?>" data-id="<?php echo $row["port_id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                                        </li>
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                                            <a class="delete_product" data-id='<?php echo $row['port_id']; ?>'>
                ...
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="port_name" name="port_name" class="form-control" placeholder="Enter port name" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Country</label>
                            <!-- <select class="form-control  basic" id="country_id_fk" name="country_id_fk"> -->
                            <select class="form-control" id="country_id_fk" name="country_id_fk" data-choices>
    ...
    <script>
        $('input[name=toggle]').change(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'ports_api/active_inactiv.php',
                data: {
                    mode: mode,
                    id: id
                },
        ...
        $(document).ready(function() {
            ...
            $('#insert').on("click", function(event) {
                ...
                if ($('#fname').val() == "") {
                    ...
                    $.ajax({
                        url: "ports_api/insert_update_ports.php",
                        method: "POST",
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#employee_id').val(data.port_id);
                        $('#port_name').val(data.port_name);
                        $('#country_id_fk').val(data.country_id_fk);
