...
$result = mysqli_query($db, "SELECT *,st.is_active as isActive FROM `ss_setup_city` as st INNER join ss_setup_state as co on co.state_id = st.state_id;
");
?>
<!doctype html>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="country">City</th>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="country"><?php echo $row["city_name"]; ?></td>
                                                                <td class="state"><?php echo $row["state_name"]; ?></td>
                ...
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="city_name" name="city_name" class="form-control" placeholder="Enter port name" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Country</label>
                            <!-- <select class="form-control  basic" id="country_id" name="country_id"> -->
                            <select class="form-control" id="state_id" name="state_id" data-choices>
                                <option>Please Select</option>
                                <?php $devices = "SELECT * FROM ss_setup_state";
    ...
    <script>
        $('input[name=toggle]').change(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'city_api/active_inactiv.php',
                data: {
                    mode: mode,
                    id: id
                },
        ...
        $(document).ready(function() {
            ...
            $('#insert').on("click", function(event) {
                ...
                if ($('#fname').val() == "") {
                    ...
                    $.ajax({
                        url: "city_api/insert_update_city.php",
                        method: "POST",
