...
// $result = mysqli_query($db, "SELECT st.state_id,st.state_name,st.country_id,st.is_active ,st.created_at,st.modified_at,co.country_name FROM `ss_setup_state` as st INNER join ss_setup_country as co on st.country_id = co.country_id;");
$result = mysqli_query($db, "SELECT *,st.is_active as isActive FROM `ss_setup_state` as st INNER join ss_setup_country as co on co.country_id = st.country_id;
");
?>
<!doctype html>
...
<body>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="hstack gap-2">
                                                ...
                                                <button type="button" class="btn btn-info" id="coontry" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-add-line align-bottom me-1"></i> Add State</button>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="country">state</th>
                                                        <th class="sort" data-sort="state">Country Name</th>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="country"><?php echo $row["state_name"]; ?></td>
                                                                <td class="state"><?php echo $row["country_name"]; ?></td>

                                                                <td class="text-center" id="iditi"> <?php if ($row["isActive"] == '0') { ?>

                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input id="SwitchCheck4<?php echo $row["state_id"]; ?>" role="switch" class="form-check-input" type="checkbox" name=toggle value="<?php echo $row["state_id"]; ?>">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input class="form-check-input" role="switch" id="toggle_<?php echo $row["state_id"]; ?>" type="checkbox" checked="" name=toggle value="<?php echo $row["state_id"]; ?>" data-toggle="toggle" data-off="Closed" data-on="Open">
                                                                                <span class="slider round mixin"></span>
                                                                            </label>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                            <a name="edit" id="<?php echo $row["state_id"]; ?>" data-id="<?php echo $row["state_id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                                        </li>
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                                            <a class="delete_product" data-id='<?php echo $row['state_id']; ?>'>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header bg-light">
            <h5 class="offcanvas-title" id="offcanvasExampleLabel">Create State</h5>
            ...
            <div data-simplebar style="height: calc(100vh - 112px);">
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Port Name</label>
                            <input type="text" id="state_name" name="state_name" class="form-control" placeholder="Enter port name" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Country</label>
                            <!-- <select class="form-control  basic" id="country_id" name="country_id"> -->
    ...
    <script>
        $('input[name=toggle]').change(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'state_api/active_inactiv.php',
                data: {
                    mode: mode,
                    id: id
                },
        ...
        $(document).ready(function() {
            ...
            $('#insert').on("click", function(event) {
                ...
                if ($('#fname').val() == "") {
                    ...
                    $.ajax({
                        url: "state_api/insert_update_state.php",
                        method: "POST",
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#employee_id').val(data.state_id);
                        $('#state_name').val(data.state_name);
                        $('#country_id').val(data.country_id);
                        // alert(data.country_id_fk);
