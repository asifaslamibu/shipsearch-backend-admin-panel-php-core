...
$result = mysqli_query($db, "SELECT * FROM `ss_setup_region`");
?>
<!doctype html>
...
<body>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="hstack gap-2">
                                                ...
                                                <button type="button" class="btn btn-info" id="coontry" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-add-line align-bottom me-1"></i> Add Region</button>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="region">Region Name</th>
                                                        <th class="sort" data-sort="ports">Water Ways</th>
                                                        <th class="sort" data-sort="ports">No Off Water Ways</th>
                                                        <th class="sort" data-sort="ports">Ports</th>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="region"><?php echo $row["region_name"]; ?></td>
                                                                <td class="ports"><?php echo $row["waterways"]; ?></td>
                                                                <td class="ports"><?php echo $row["no_of_waterways"]; ?></td>
                                                                <td class="ports"><?php echo $row["no_of_ports"]; ?></td>

                                                                <td class="text-center" id="iditi"> <?php if ($row["is_active"] == '0') { ?>

                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input id="SwitchCheck4<?php echo $row["region_id"]; ?>" role="switch" class="form-check-input" type="checkbox" name=toggle value="<?php echo $row["region_id"]; ?>">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <div class="form-check form-switch">
                                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                                                <input class="form-check-input" role="switch" id="toggle_<?php echo $row["region_id"]; ?>" type="checkbox" checked="" name=toggle value="<?php echo $row["region_id"]; ?>" data-toggle="toggle" data-off="Closed" data-on="Open">
                                                                                <span class="slider round mixin"></span>
                                                                            </label>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                                        ...
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                            <a name="edit" id="<?php echo $row["region_id"]; ?>" data-id="<?php echo $row["region_id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                                        </li>
                                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                                            <a class="delete_product" data-id='<?php echo $row['region_id']; ?>'>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header bg-light">
            <h5 class="offcanvas-title" id="offcanvasExampleLabel">Create Region</h5>
            ...
            <div data-simplebar style="height: calc(100vh - 112px);">
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Region Name</label>
                            <input type="text" id="region_name" name="region_name" class="form-control" placeholder="Enter Region Name" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Waterways Name</label>
                            <input type="text" id="waterways" name="waterways" class="form-control" placeholder="Enter Waterways Name" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Number Of Waterways</label>
                            <input type="number" id="no_of_waterways" name="no_of_waterways" class="form-control" placeholder="Enter Number Of Waterways" required="">
                        </div>
                        <div class="mb-3">
                            <label for="date-field" class="form-label">Number Of Ports</label>
                            <input type="number" id="no_of_ports" name="no_of_ports" class="form-control" placeholder="Enter Number Of Ports" required="">
                        </div>
    ...
    <script>
        $('input[name=toggle]').change(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'region_api/active_inactiv.php',
                data: {
                    mode: mode,
                    id: id
                },
        ...
        $(document).ready(function() {
            ...
            $('#insert').on("click", function(event) {
                ...
                if ($('#fname').val() == "") {
                    ...
                    $.ajax({
                        url: "region_api/insert_update_region.php",
                        method: "POST",
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                // alert(employee_id)
                $.ajax({
                    url: "region_api/fetch_region.php",
                    method: "POST",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $('#employee_id').val(data.region_id);
                        $('#region_name').val(data.region_name);
                        $('#waterways').val(data.waterways);
                        $('#no_of_waterways').val(data.no_of_waterways);
                        $('#no_of_ports').val(data.no_of_ports);
            ...
            $(document).on('click', '.delete_product', function(e) {
                ...
                if (confirmalert == true) {
                    // AJAX Request
                    $.ajax({
                        url: 'region_api/delet_region.php',
                        type: 'POST',
                        data: {
                            id: deleteid
                        },
